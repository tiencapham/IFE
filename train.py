...
if __name__ == '__main__':
    ...
    watermark = f"{name}_standard"
    wandb.init(project=f'rainbow_{name}', save_code=True, config=dict(**wandb_log_config, log_version=100), name = watermark,
    ...
    for game_frame in t:
        ...
        if game_frame % (5_000_000-(500_000 % args.parallel_envs)) == 0 and game_frame > 0:
